...
class Evaluate():
    ...
    def getHrNdcgProc(self, 
        ...
        for u in user_list:
            ...
            #set_trace()
            sort_index = np.argsort(real_item_rating_list)       # ranking: samll ->  large
            sort_index = sort_index[::-1]                       # ranking: large ->  small
            ...
            #set_trace()
            tmp_hr = np.sum(user_hr_list) / target_length  # original
